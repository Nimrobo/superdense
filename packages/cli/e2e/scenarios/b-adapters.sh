...
list="$(road42 session list --agent claude-code 2>&1)"
...
road42 discover >/dev/null
road42 index >/dev/null
clist="$(road42 session list --agent codex 2>&1)"
...
road42 discover >/dev/null
road42 index >/dev/null
olist="$(road42 session list --agent opencode 2>&1)"
