...
const overview: apiModule.RewardOverview = {
  status: {
    ...
    stages: [
      ...
      { key: 'reconcile', label: 'Reconcile', unit: 'artifacts', actionable: 0, skill: 'reconcile.md' },
  ...
  projects: [
    {
      ...
      curation: { pending: 1, deferred: 0, consumed: 0, skipped: 0, remaining: 1, attachedConsumed: 0 },
    ...
    },
    {
      ...
      nextAction: { stage: 'curate', skill: 'curate.md', command: 'Read curate.md for project p1', why: '3 sessions at Curate' },
    },
  ],
  typeSummaries: [
    { type: 'launch', connector: null, artifactCount: 2, externalizedCount: 1, withRewardsCount: 1 },
  ],
};
