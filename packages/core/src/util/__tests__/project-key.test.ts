...
describe('resolveProjectKey', () => {
  it('strips the workspace from a Conductor workspace root', () => {
    expect(resolveProjectKey('/Users/x/conductor/workspaces/superdense/provo-v1')).toBe(
      '/Users/x/conductor/workspaces/superdense',
    );
  });

  it('strips the workspace and nested path from a Conductor subdirectory', () => {
    expect(
      resolveProjectKey('/Users/x/conductor/workspaces/superdense/provo-v1/packages/core'),
