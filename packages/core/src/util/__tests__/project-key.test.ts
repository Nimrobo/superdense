...
describe('resolveProjectKey', () => {
  it('strips the workspace from a Conductor workspace root', () => {
    expect(resolveProjectKey('/Users/x/conductor/workspaces/road42/provo-v1'))
      .toBe('/Users/x/conductor/workspaces/road42');
  });

  it('strips the workspace and nested path from a Conductor subdirectory', () => {
    expect(resolveProjectKey('/Users/x/conductor/workspaces/road42/provo-v1/packages/core'))
      .toBe('/Users/x/conductor/workspaces/road42');
  });
