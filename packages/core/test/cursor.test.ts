...
async function writeWorkspace(
  ...
  db.prepare(`INSERT INTO ItemTable (key, value) VALUES (?, ?)`).run(
    ...
    JSON.stringify({ allComposers: composerIds.map((id) => ({ composerId: id })) }),
  );
  db.close();
}
...
describe('cursorAdapter', () => {
      ...
      [
        {
          ...
          value: { bubbleId: 'b1', type: 1, text: 'Help me ship', createdAt: '2026-05-21T04:00:00.000Z' },
        },
        {
          key: 'bubbleId:composer-1:b2',
          value: { bubbleId: 'b2', type: 2, text: 'Sure', createdAt: '2026-05-21T04:00:05.000Z' },
        },
      ],
    );
  ...
  it('skips composers without a workspace mapping', async () => {
    ...
    writeGlobalDb(
      ...
      [{ key: 'bubbleId:orphan:b1', value: { bubbleId: 'b1', type: 1, text: 'hi' } }],
    );
  ...
  it('normalizes user text, assistant text, and tool call+result from one bubble', async () => {
    ...
    writeGlobalDb(
      ...
      [
        {
          key: 'bubbleId:c1:b1',
          value: { bubbleId: 'b1', type: 1, text: 'Run tests', createdAt: '2026-05-21T04:00:00.000Z' },
        },
        {
          key: 'bubbleId:c1:b2',
          value: { bubbleId: 'b2', type: 2, text: 'I will run them.', createdAt: '2026-05-21T04:00:01.000Z' },
        },
        {
          key: 'bubbleId:c1:b3',
          value: {
    ...
    expect(events).toMatchObject([
      ...
      { kind: 'tool_result', role: 'user', toolCallId: 'toolu_ok', isError: false, text: 'all good' },
      {
        kind: 'tool_call',
        role: 'assistant',
        toolCallId: 'toolu_bad',
      ...
      { kind: 'tool_result', role: 'user', toolCallId: 'toolu_bad', isError: true, text: 'exit 1' },
    ]);
  });
  ...
  it('emits plan-boundary transitions only; assistants inherit the user-set mode', async () => {
    ...
    writeGlobalDb(
      ...
      [
        ...
        { key: 'bubbleId:cp:b1', value: { bubbleId: 'b1', type: 1, text: 'start in agent', unifiedMode: 2, createdAt: '2026-05-21T04:00:00.000Z' } },
        { key: 'bubbleId:cp:b2', value: { bubbleId: 'b2', type: 2, text: 'sure', unifiedMode: 2, createdAt: '2026-05-21T04:00:01.000Z' } },
        // User enters plan mode — transition emitted at THIS user bubble.
        { key: 'bubbleId:cp:b3', value: { bubbleId: 'b3', type: 1, text: 'lets plan', unifiedMode: 5, createdAt: '2026-05-21T04:00:02.000Z' } },
        // Assistant's bubble (unifiedMode=2 like always) must inherit plan, NOT exit.
        { key: 'bubbleId:cp:b4', value: { bubbleId: 'b4', type: 2, text: 'here is the plan', unifiedMode: 2, createdAt: '2026-05-21T04:00:03.000Z' } },
        // Another in-plan user turn — no transition.
        { key: 'bubbleId:cp:b5', value: { bubbleId: 'b5', type: 1, text: 'tweak it', unifiedMode: 5, createdAt: '2026-05-21T04:00:04.000Z' } },
        { key: 'bubbleId:cp:b6', value: { bubbleId: 'b6', type: 2, text: 'updated plan', unifiedMode: 2, createdAt: '2026-05-21T04:00:05.000Z' } },
        // User toggles back — exit emitted at this user bubble.
        { key: 'bubbleId:cp:b7', value: { bubbleId: 'b7', type: 1, text: 'go ahead', unifiedMode: 2, createdAt: '2026-05-21T04:00:06.000Z' } },
        // Subsequent assistant inherits default; isPlanExecution stays default (no extra emit).
        { key: 'bubbleId:cp:b8', value: { bubbleId: 'b8', type: 2, text: 'executing', unifiedMode: 2, isPlanExecution: true, createdAt: '2026-05-21T04:00:07.000Z' } },
      ],
    );
    ...
    expect(modeChanges).toEqual([
      { ts: Date.parse('2026-05-21T04:00:02.000Z'), kind: 'mode_change', mode: 'plan', prevMode: 'default' },
      { ts: Date.parse('2026-05-21T04:00:06.000Z'), kind: 'mode_change', mode: 'default', prevMode: 'plan' },
    ]);
  });
  ...
  it('does not emit any mode_change for a session that never enters plan mode', async () => {
    ...
    writeGlobalDb(
      ...
      [
        { key: 'bubbleId:cp:b1', value: { bubbleId: 'b1', type: 1, text: 'hi', unifiedMode: 1, createdAt: '2026-05-21T04:00:00.000Z' } },
        { key: 'bubbleId:cp:b2', value: { bubbleId: 'b2', type: 2, text: 'hello', unifiedMode: 2, createdAt: '2026-05-21T04:00:01.000Z' } },
        { key: 'bubbleId:cp:b3', value: { bubbleId: 'b3', type: 1, text: 'do it', unifiedMode: 2, createdAt: '2026-05-21T04:00:02.000Z' } },
      ],
    );
