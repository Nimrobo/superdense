...
6. Apply mutable work-thread edits with `superdense curation apply --input '<json|@file>'`.
7. Stop after the bounded batch and report applied actions plus remaining inbox counts.
